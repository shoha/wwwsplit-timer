    ...
    function (d3Service, $window, $timeout) {
      return {
        ...
        link: function ($scope, elem, attrs) {
          var d3, id_function, init, line, origin_line, padding, prev_chart_height, prev_chart_width, relative_time_function, resize_timer, svg, time_function, transition_time, update_chart, x, y;
          d3 = d3Service.d3();
          ...
          update_chart = function (init) {
            ...
            y.domain(d3.extent($scope.data, relative_time_function)).range([
              chart_height,
              0
            ]);
            svg.selectAll('path.origin_line').data([[
                [
                  0,
                  0
                ],
              ...
              ]]).transition().duration(transition_time).attr('d', origin_line);
  ...
  angular.module('wwwsplit-timer.charts', ['d3']).directive('lineChart', [
    ...
    function (a, b, c) {
      return {
        ...
        restrict: 'C',
        link: function (d, e) {
          var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u;
          return f = a.d3(), q = function (a) {
            return a.x;
          }, n = function (a) {
            return a.y;
          }, g = function (a) {
            ...
            top: 20,
            bottom: 20
          }, t = f.scale.linear(), u = f.scale.linear(), p = f.select(e[0]).append('svg').attr('transform', 'translate(' + k.left + ', ' + k.top + ')'), i = f.svg.line().x(function (a) {
            return t(q(a));
          }).y(function (a) {
            return u(n(a));
          }).interpolate('linear'), p.append('svg:path').attr('class', 'timer_line'), j = f.svg.line().x(function (a) {
            return a[0];
          }).y(function (a) {
            return u(a[1]);
          }).interpolate('linear'), p.append('svg:path').attr('class', 'origin_line'), s = function () {
            var a, b, c;
            return b = window.getComputedStyle(e[0]).width.substring(0, window.getComputedStyle(e[0]).width.length - 2) - (k.left + k.right), a = window.getComputedStyle(e[0]).height.substring(0, window.getComputedStyle(e[0]).height.length - 2) - (k.bottom + k.top), m = b, l = a, p.attr('width', b + k.left + k.right), p.attr('height', a + k.top + k.bottom), t.domain(f.extent(d.data, q)).range([
              0,
              b
            ]), u.domain(f.extent(d.data, n)).range([
              a,
              0
            ]), p.selectAll('path.origin_line').data([[
                [
                  0,
                  0
                ],
              ...
              ]]).transition().duration(r).attr('d', j), p.selectAll('path.timer_line').data([d.data]).transition().duration(r).attr('d', i), c = p.selectAll('circle').data(d.data, g), c.transition().duration(r).attr('cx', function (a) {
              return t(q(a));
            }).attr('cy', function (a) {
              return u(n(a));
            }), c.enter().append('circle').attr('cx', function (a) {
              return t(q(a));
            }).attr('cy', function (a) {
              return u(n(a));
            }).attr('r', 4).attr('class', 'circle'), c.exit().remove();
          }, o = void 0, b.onresize = function () {
            return null != o && c.cancel(o), o = c(function () {
              return s(h);
            }, 100);
