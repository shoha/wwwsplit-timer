    ...
    function (d3Service, $window, $timeout) {
      return {
        ...
        link: function ($scope, elem, attrs) {
          var bg, chart_height, chart_width, d3, g, id_function, init, margin, prev_chart_height, prev_chart_width, relative_time_function, resize_timer, svg, time_function, timer_line, transition_time, update_chart, x, y;
          d3 = d3Service.d3();
          ...
          timer_line = d3.svg.line().x(function (d) {
